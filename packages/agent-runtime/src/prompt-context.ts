...
export const GENERAL_GAME_AUTHORING_MODULES: readonly PromptModuleDefinition[] = Object.freeze([
  ...
  module('prompt.workflow.general-authoring', '1.6.0', 'workflow', [
    ...
    'After changes, run repeatable data checks and the visual checks relevant to the requirements, diagnose failures from new evidence, and stop unchanged retries when the repair budget is exhausted.',
  ]),
