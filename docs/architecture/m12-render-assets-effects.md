...
- Device loss pauses 3D mixer evaluation plus owned 2D-animation and 2D/3D-particle simulation systems, and is visible in the manifest; device restoration resumes the same owners.
