...
assert.equal(revalidation.gates.packageTests.passed, 128);
...
assert.ok(revalidation.faultMatrix.covered.includes('agent-diagnostics-controlled-repair-after-restart'));
