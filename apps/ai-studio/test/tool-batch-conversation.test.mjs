...
test('Conversation Host overlaps safe bodies, honors an exclusive barrier, and commits in provider order', async () => {
  const submitted = [];
  ...
  assert.ok(elapsed < 220, `batch unexpectedly took ${elapsed}ms`);
