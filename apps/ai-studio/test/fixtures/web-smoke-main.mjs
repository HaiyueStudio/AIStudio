            ...
            wait(() => document.querySelector('#selection-label')?.textContent === 'Cube', () => {
              ...
              wait(() => !document.querySelector('#commit-script').disabled, () => {
                ...
                wait(() => !document.querySelector('#prepare-preview').disabled, () => {
                  document.querySelector('#prepare-preview').click();
                  wait(() => !document.querySelector('#approve-preview').disabled, () => {
                    document.querySelector('#approve-preview').click();
                    wait(() => document.body.dataset.preview === 'playing' && !document.querySelector('#stop-preview').disabled, () => {
                      document.querySelector('#stop-preview').click();
                      wait(() => document.body.dataset.preview === 'stopped', () => resolve({
