...
test('desktop composition sends one bounded Scene baseline and exact revision deltas without script text', async () => {
  ...
  try {
    ...
    await context.commit({ conversationKey: 'conversation:g05-app', backendId: 'backend:g05-app', taskId: 'task:g05-app-1', sessionId: 'session:g05-app', turnId: 'turn:g05-app-1', projectId: firstProject.projectId, goals: [], decisions: [], toolFacts: [], acceptance: [], blockers: [] });
