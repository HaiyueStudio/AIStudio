...
const ENGINE_GUIDES: readonly ReviewedEngineGuide[] = Object.freeze([
  ...
  Object.freeze({
    ...
    text: 'Map keyboard and pointer input to named gameplay actions. A pressed action is a one-tick transition while held input remains active across ticks. Pointer coordinates are viewport-normalized. Define down, move, up, cancel and invalid gesture behavior, then verify each authoritative transition by deterministic Play input and inspection.',
  }),
  Object.freeze({
